import { Radio, Cpu, GitBranch, Linkedin } from 'lucide-react'

const HIGHLIGHTS = [
  { icon: <Radio size={13} />, title: 'RADIO DRIVERS', desc: 'Target agnostic driver implementation' },
  { icon: <Cpu size={13} />, title: 'HARDWARE TESTING', desc: 'Dynamic Hardware validation' },
  { icon: <GitBranch size={13} />, title: 'CI AUTOMATION', desc: 'Automated nightly hardware testing' },
]
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1240, width: '100%', margin: '0 auto', position: 'relative' }}>
        ...
        <div className="work-grid" style={{ alignItems: 'start' }}>

          {/* Left: team photo */}
          <div style={{ display: 'flex', flexDirection: 'column', border: '1px solid rgba(0,0,0,0.1)', overflow: 'hidden', minWidth: 0, background: '#fff' }}>
            <div className="img-wrap" style={{ overflow: 'hidden', position: 'relative', aspectRatio: '4 / 3' }}>
              <img
          ...
          <div>
            ...
            <div style={{ borderLeft: '2px solid rgba(0,124,191,0.4)', paddingLeft: 20, marginBottom: 36 }}>
              <p style={{ fontSize: 13, lineHeight: 1.8, color: '#555' }}>
                Developed radio hardware drivers for Ericsson's radios, which are at the
                core of Ericsson's products. Gained experience in embedded Linux, C/bash,
                dynamic hardware testing, and hardware CI.
