      ...
      <div style={{ maxWidth: 1240, width: '100%', margin: '0 auto', position: 'relative' }}>
        ...
        <div className="work-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', border: '1px solid rgba(0,0,0,0.1)', overflow: 'hidden', minWidth: 0, background: '#fff' }}>
            <div className="img-wrap" style={{ overflow: 'hidden', position: 'relative', aspectRatio: '16 / 9' }}>
              <img
          ...
          <div>
            ...
            <h2 style={{
              ...
              INFRA<br /><span style={{ color: '#007cbf' }}>SONIK</span>
            </h2>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
              {['INFRASOUND', 'PROTOTYPE DEV', 'LAB TESTING', 'R&D'].map(t => (
                <span key={t} className="tag" style={{ borderColor: 'rgba(0,124,191,0.35)', color: '#007cbf' }}>{t}</span>
              ))}
            </div>
          </div>
        </div>
